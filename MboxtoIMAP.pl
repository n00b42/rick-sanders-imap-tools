...
# $Header: /mhub4/sources/imap-tools/MboxtoIMAP.pl,v 1.23 2016/03/10 14:05:43 rick Exp $
...
sub init {
   ...
   if ( !getopts('m:L:i:dIr:RDf:n:p:UM:t:WA:F:u:') ) {
      usage();
      exit;
   }
...
sub usage {
   ...
   print "To use CRAM-MD5 for the logins add this:  -i server/user/password/CRAM-MD5\n";
