...
# $Header: /mhub4/sources/imap-tools/imap_search.pl,v 1.5 2015/12/10 05:17:39 rick Exp $
...
sub usage {
   ...
   print "Add CRAM-MD5 for CRAM-MD5 logins like this:  host/user/pwd/CRAM-MD5\n";
   exit;
