...
# $Header: /mhub4/sources/imap-tools/imap_to_maildir.pl,v 1.7 2015/12/05 12:43:33 rick Exp $
...
sub usage {
   ...
   print "To use CRAM-MD5 for logins add /CRAM-MD5 like this:  -i host/user/password/CRAM-MD5\n";
   exit;
