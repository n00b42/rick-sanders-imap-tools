...
# $Header: /mhub4/sources/imap-tools/pop3toimap.pl,v 1.13 2016/03/10 12:27:43 rick Exp $
...
use MIME::Base64 qw( encode_base64 decode_base64 );
   ...
   if ( $usersFile ) {
      $imapHost = $opt_i;
      $method = 'CRAM-MD5' if $imapHost =~ /CRAM-MD5/i;
...
sub usage {
   ...
   print "   -u <input file>  popUser popPwd imapUser imapPwd\n";
   ...
   print "To use CRAM-MD5 logins on the IMAP server add /CRAM-MD5 like this:  -i host/user/password/CRAM-MD5\n";
